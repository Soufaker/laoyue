...
def nuclei(filename):
    ...
    print('/root/nuclei -l ' + str(filename) + ' -o ' + str(loud_file))
    os.system('/root/nuclei -l ' + str(filename) + ' -o ' + str(loud_file))
    list1 = []
    list2 = []
...
if __name__ == '__main__':
    ...
    time.sleep(7200)
    os.system('nohup python3 infoinfo.py  -d "SRC.txt" -z 1 -m 1 -n 1 &')